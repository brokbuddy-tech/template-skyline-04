    ...
    <div className="w-full max-w-5xl mx-auto p-4 z-20">
      ...
      <div className="bg-white/90 backdrop-blur-sm rounded-full p-2 shadow-2xl flex flex-col md:flex-row items-center gap-3 w-full">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <div className="bg-gray-100/80 rounded-full px-6 py-4 flex items-center justify-between min-w-[220px] w-full md:w-auto cursor-pointer hover:bg-gray-200 transition">
              ...
              <ChevronDown className="w-5 h-5 text-blue-800 ml-2" />
            </div>
          </DropdownMenuTrigger>
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-end">
          <Button
            size="icon"
            className="w-14 h-14 bg-[#1E3A8A] rounded-full text-white shadow-lg hover:scale-105 transition"
            aria-label="Search"
          >
          ...
          <Button
            size="icon"
            variant="secondary"
            className="w-14 h-14 bg-gray-100 rounded-full text-[#1E3A8A] hover:bg-gray-200 transition"
            aria-label="Filters"
          >
